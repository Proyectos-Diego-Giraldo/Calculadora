...
function calculateNote(event) {
    ...
    resultNote.textContent = `Sr(a)(e)(i) ${name}, su nota es de: ${finalNote.toFixed(2)}`;
}
...
function calculateNote(event) {
    ...
    if (finalNote < 3.5) {
        resultNote.textContent = `Sr(a)(e)(i) ${name}, ha perdido la materia.`;
        resultNote.style.color = "black";
    } else if (finalNote >= 3.5 && finalNote <= 4.5) {
        resultNote.textContent = `Sr(a)(e)(i) ${name}, ha ganado la materia.`;
        resultNote.style.color = "orange";
    } else {
        resultNote.textContent = `Sr(a)(e)(i) ${name}, su nota es sobresaliente.`;
